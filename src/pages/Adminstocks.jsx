...
const Adminstocks = () => {
  ...
  const fetchAdminStock = async () => {
    try {
      const response = await axios.get("https://outstanding-gray-xerus.cyclic.app/adminstocks/",{
        headers:{
  ...
  const handleDeleteStock = async (stockId) => {
    try {
      await axios.delete(`https://outstanding-gray-xerus.cyclic.app/adminstocks/${stockId}`,{
        method:"DELETE",
        headers:{
          "Content-type":"application/json",
          authorization:`Bearer ${localStorage.getItem("token")}`
...
/////////////////////////////////////////////////////////////////////
  ...
  const handleUpdate = async () => {
    try {
      ...
      await axios.patch(
        `https://outstanding-gray-xerus.cyclic.app/adminstocks/${selectedStock._id}`,
        selectedStock,{
          method:"PATCH",
          headers:{
            "Content-type":"application/json",
  ...
  const handleAddStock = async () => {
    try {
      ...
      await axios.post("https://outstanding-gray-xerus.cyclic.app/adminstocks", newStock,
      {
        method:"POST",
        headers:{
          "Content-type":"application/json",
